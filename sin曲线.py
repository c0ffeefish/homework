...
def MeanSquareLoss(x, y, thetaArray):
    m = len(y)
    pd = thetaArray[0] + thetaArray[1] * x + thetaArray[2] * (x ** 2) + thetaArray[3] * (x ** 3) + thetaArray[4] * (x ** 4) + thetaArray[
        5] * (x ** 5)
...
y_final = thetaArray_gd[0] + thetaArray_gd[1] * xStand + thetaArray_gd[2] * (xStand ** 2) + \
            thetaArray_gd[3] * (xStand ** 3) + thetaArray_gd[4] * (xStand ** 4) + thetaArray_gd[5] * (
                        xStand ** 5)
